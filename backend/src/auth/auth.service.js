...
var AuthService = function () {
    ...
    var AuthService = _classThis = /** @class */ (function () {
        function AuthService_1(userRepository, auditLogRepository, jwtService) {
        ...
        AuthService_1.prototype.login = function (user, ipAddress) {
            return __awaiter(this, void 0, void 0, function () {
                var payload;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            // Check if user is approved or is staff/admin
                            if (user.status !== 'approved' && user.role === 'voter') {
                            ...
                            return [4 /*yield*/, this.auditLogRepository.save({
                                    ...
                                    details: "Login from ".concat(ipAddress)
                                })];
                        case 1:
                            // Create audit log
                            _a.sent();
        ...
        AuthService_1.prototype.register = function (userData, ipAddress) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            if (existingUser) {
                                throw new common_1.UnauthorizedException('Email or Voter ID already exists');
                            }
                        ...
                        case 3:
                            ...
                            return [4 /*yield*/, this.auditLogRepository.save({
                                    ...
                                    ip_address: ipAddress,
                                    details: "New registration from ".concat(ipAddress)
                                })];
                        case 4:
                            // Create audit log
                            _a.sent();
        ...
        AuthService_1.prototype.logout = function (userId, userEmail, ipAddress) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.auditLogRepository.save({
                                user_id: userId,
                                user_email: userEmail,
                                action: 'User logged out',
                                ip_address: ipAddress,
                                details: "Logout from ".concat(ipAddress)
                            })];
                        case 1:
                            _a.sent();
