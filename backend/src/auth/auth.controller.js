...
var AuthController = function () {
    ...
    var AuthController = _classThis = /** @class */ (function () {
        ...
        AuthController_1.prototype.login = function (body, req) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, this.authService.login(user, ipAddress)];
                    }
                });
            });
        };
        AuthController_1.prototype.register = function (body, req) {
            return __awaiter(this, void 0, void 0, function () {
                var ipAddress;
                return __generator(this, function (_a) {
                    ipAddress = req.ip || req.connection.remoteAddress;
                    return [2 /*return*/, this.authService.register(body, ipAddress)];
                });
            });
        };
        AuthController_1.prototype.logout = function (req) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ipAddress = req.ip || req.connection.remoteAddress;
                    return [2 /*return*/, this.authService.logout(req.user.id, req.user.email, ipAddress)];
                });
            });
        };
    ...
    (function () {
        ...
        _logout_decorators = [(0, common_1.Post)('logout'), (0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt'))];
