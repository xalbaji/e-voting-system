        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, connection.query("CREATE DATABASE IF NOT EXISTS evoting_db")];
                case 3:
                    // Create database if it doesn't exist
                    _a.sent();
                    console.log('Database "evoting_db" created or already exists');
                    // Use the database
                    return [4 /*yield*/, connection.query("USE evoting_db")];
                case 4:
                    // Use the database
                    _a.sent();
                ...
                case 6:
                    ...
                    return [3 /*break*/, 9];
                case 7: return [4 /*yield*/, connection.end()];
                case 8:
                    _a.sent();
                    return [7 /*endfinally*/];
